...
public class StatisticsPanel extends JPanel
{
	...
	public StatisticsPanel()
	{
		...
		int y=0;
		add(createLabel(null, "NavData Variþ Orani: "), new GridBagConstraints(0, y, 1, 1, 1, 1, GridBagConstraints.FIRST_LINE_START, GridBagConstraints.NONE, new Insets(0,0,0,0), 0, 0));
		...
		add(createLabel(null, "Resim Variþ Orani: "), new GridBagConstraints(0, y, 1, 1, 1, 1, GridBagConstraints.FIRST_LINE_START, GridBagConstraints.NONE, new Insets(0,0,0,0), 0, 0));
