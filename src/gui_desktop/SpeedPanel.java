...
public class SpeedPanel extends JPanel
{
	...
	public SpeedPanel(final KeyboardCommandManager cmdManager, int defaultSpeed)
	{
		...
		slider.addChangeListener(new ChangeListener() {
			...
			{
				System.out.println("Oyun hizi ayari: " + slider.getValue());
		...
		add(new JLabel("Hiz"), new GridBagConstraints(0,1,1,1,1,0,GridBagConstraints.SOUTH, GridBagConstraints.NONE, new Insets(0,0,5,0), 0, 0));
