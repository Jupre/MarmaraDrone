...
public class VisionTag
{
    ...
    public static enum VisionTagType
    {
        ...
        CAD_TYPE_VISION(2), /* Drone kodlarý üzerinde yatay 2D etiketleri Algýlama */
        CAD_TYPE_NONE(3), /* algýlama devre dýþý */
        CAD_TYPE_COCARDE(4), /* Drone altýnda madalyon tespit */
        CAD_TYPE_ORIENTED_COCARDE(5), /*
                                       * Drone altýnda odaklý madalyon tespit
                                       * 
                                       */
        CAD_TYPE_STRIPE(6), /* Yere düzgün bir þerit tespit */
        CAD_TYPE_H_COCARDE(7), /* Drone önünde bir madalyon tespit */
        CAD_TYPE_H_ORIENTED_COCARDE(8), /*
                                         * Drone önünde bir odaklý madalyon tespit
                                         * 
                                         */
        CAD_TYPE_STRIPE_V(9), CAD_TYPE_MULTIPLE_DETECTION_MODE(10), /*
                                                                     ...
                                                                     * kullanýr
                                                                     */
        CAD_TYPE_NUM(11); /*  CAD_TYPE için olasý deðerlerin sayýsý */
